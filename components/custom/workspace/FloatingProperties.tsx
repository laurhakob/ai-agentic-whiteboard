...
//   // Close popovers when a different element is selected
//   useEffect(() => {
//     setOpenPanel(null);
...
//   if (!selectedElement || !excalidrawAPI) return null;
...
//   const toggleLock = () => {
//     patch({ locked: !selectedElement.locked });
//   };
...
//         <IconButton title="Delete" danger onClick={remove}>
//           <Trash2 size={17} />
//         </IconButton>
...
//             onPick={(c) => patch({ backgroundColor: c })}
//             onClear={() => patch({ backgroundColor: "transparent" })}
//           />
//         </Popover>
//       )}
...
//           <Section>
//             <div className="flex gap-2">
//               <OptionButton wide onClick={bringFront}>
//                 <ArrowUpToLine size={15} />
//                 Bring front
//               </OptionButton>
//               <OptionButton wide onClick={sendBack}>
...
//                     onClick={() => patch({ strokeStyle: s.value })}
//                   >
//                     {s.label}
//                   </OptionButton>
//                 ))}
...
//             ${value === c ? "ring-2 ring-blue-400 ring-offset-1" : "border-gray-200"}`}
//         />
//       ))}
